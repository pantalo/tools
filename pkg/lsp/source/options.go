...
import (
	...
	"golang.org/x/tools/pkg/lsp/analysis/fillreturns"
	"golang.org/x/tools/pkg/lsp/analysis/fillstruct"
	"golang.org/x/tools/pkg/lsp/analysis/nonewvars"
	"golang.org/x/tools/pkg/lsp/analysis/noresultvalues"
	"golang.org/x/tools/pkg/lsp/analysis/simplifycompositelit"
	"golang.org/x/tools/pkg/lsp/analysis/simplifyrange"
	"golang.org/x/tools/pkg/lsp/analysis/simplifyslice"
