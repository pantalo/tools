...
import _ "golang.org/x/tools/pkg/lsp/assign/internal/secret" //@diag("\"golang.org/x/tools/pkg/lsp/assign/internal/secret\"", "compiler", "could not import golang.org/x/tools/internal/lsp/assign/internal/secret (invalid use of internal package golang.org/x/tools/internal/lsp/assign/internal/secret)", "error")
